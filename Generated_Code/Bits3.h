...
#define Bits3_PRPH_BASE_ADDRESS  0x400FF040U
...
#define Bits3_MODULE_BASE_ADDRESS FPTB_BASE_PTR /*!< Name of macro used as the base address */
#define Bits3_PORTCONTROL_BASE_ADDRESS PORTB_BASE_PTR /*!< Name of macro used as the base address */
#define Bits3_PORT_MASK 0x2000U        /*!< Mask of the allocated pin from the port */
#define Bits3_PORT_VALID_VALUE_MASK 0x01 /*!< Mask of the allocated pins from the port as the first pin would be zero i.e. valid bits to be set in method PutVal */
#define Bits3_PIN_ALLOC_0_MASK 0x2000  /*!< Mask of the first allocated pin from the port */
#define Bits3_PIN_ALLOC_0_INDEX 13U    /*!< The index of the first allocated pin from the port */
