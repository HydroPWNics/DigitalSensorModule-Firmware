...
static const uint32_t Bits2_PIN_MASK_MAP[1U] = {
   0x1000U
...
uint32_t Bits2_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  return PortData >> Bits2_PIN_ALLOC_0_INDEX; /* Return port data shifted with the offset of the first allocated pin*/
}
...
void Bits2_PutVal(LDD_TDeviceData *DeviceDataPtr, uint32_t Val)
{
  ...
  RawVal = (Val & Bits2_PORT_VALID_VALUE_MASK) << Bits2_PIN_ALLOC_0_INDEX; /* Mask and shift output value */
